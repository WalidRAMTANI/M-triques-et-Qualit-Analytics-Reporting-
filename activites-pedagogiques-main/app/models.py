...
class TypeActivite(str, Enum):
    """Type d'activité pour les exercices."""
...
# ============================================
# MODÈLES GROUPE 4 (ACTIVITÉS ET SESSIONS)
# ============================================
...
class ActiviteUpdate(BaseModel):
    """Modèle d'une mise à jour partielle d'une activité"""
...
class Attempt(BaseModel):
    """Tentative d'un apprenant sur une activité"""
