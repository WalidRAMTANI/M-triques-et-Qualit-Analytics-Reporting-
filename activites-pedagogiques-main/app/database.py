...
def init_database():
    ...
    with get_db_connection() as conn:
        ...
        # ============================================
        # TABLE SPÉCIFIQUE: Activité pédagogique (Groupe 4)
        # ============================================
        cursor.execute(
            """
            CREATE TABLE IF NOT EXISTS activite_pedagogique (
                ...
                nom TEXT,
                description TEXT,
                type_activite TEXT, -- 'pilotee', 'prof_definie', 'revision'
                ids_exercices_inclus TEXT, -- JSON array
                discipline TEXT,
        ...
        # ============================================
        # TABLE SPÉCIFIQUE: Session apprenant (Groupe 4)
        # ============================================
        cursor.execute(
            """
        ...
        # ============================================
        # TABLE SPÉCIFIQUE: Exercice détail (Groupe 4)
        # ============================================
        cursor.execute(
            """
            CREATE TABLE IF NOT EXISTS exercice_detail ( -- si stockage local des exercices
                id_exercice INTEGER PRIMARY KEY,
                titre TEXT,
                id_aav_cible INTEGER,
                type_evaluation TEXT,
                contenu TEXT, -- JSON avec l'exercice
                difficulte REAL
            )
        """
        )
